...
var file_internal_delivery_grpc_pb_user_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x65, 0x72, 0x1a, 0x2c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x64,
	...
	0x74, 0x6f, 0x22, 0x49, 0x0a, 0x15, 0x46, 0x6f, 0x72, 0x67, 0x6f, 0x74, 0x50, 0x61, 0x73, 0x73,
	...
	0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x0e,
...
var file_internal_delivery_grpc_pb_user_proto_goTypes = []interface{}{
	(*ForgotPasswordRequest)(nil), // 0: durudex.user.ForgotPasswordRequest
	(*types.Status)(nil),          // 1: types.Status
}
var file_internal_delivery_grpc_pb_user_proto_depIdxs = []int32{
	0, // 0: durudex.user.UserService.ForgotPassword:input_type -> durudex.user.ForgotPasswordRequest
	1, // 1: durudex.user.UserService.ForgotPassword:output_type -> types.Status
